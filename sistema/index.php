    ...
    padding-bottom: 25px;">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="../index.html">SERVICIOS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="../servicios.html" >GALERÍA</a>
                </li>
                <li class="nav-item">
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg" style="    margin-top: 10rem !important;">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">PROMASI</h3>
                                </div>
                                <div class="card-body">
                                ...
                                <button type="submit" class="btn" style="background-color: #113448 ; color: #fff;  opacity: 0.5;">Ingresar</button>
                            </div>
                            </form>
                        </div>
                    </div>
